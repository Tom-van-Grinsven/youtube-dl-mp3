...
echo -e $Y $L"YouTube-dl Installer By"  $R "Tom" $N
...
echo -e $Y $L "Getting config file..." $N
		wget https://raw.githubusercontent.com/Tom-van-Grinsven/youtube-dl-mp3/master/config -P /data/data/com.termux/files/home/.config/youtube-dl
...
echo -e $Y $L "Getting files..." $N
		wget https://raw.githubusercontent.com/Tom-van-Grinsven/youtube-dl-mp3/master/termux-url-opener -P /data/data/com.termux/files/home/bin
		clear
